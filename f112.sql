...
,p_logo_image=>'http://novajii.com/img/ruby/assets/ruby-top-white.fw.png'
...
,p_csv_encoding=>'Y'
,p_substitution_string_01=>'NGN'
,p_substitution_value_01=>'₦'
,p_substitution_string_02=>'CONTACT_ADMIN'
,p_substitution_value_02=>'Operation Failed. <br>Contact System Admin about this'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20160624190212'
...
,p_security_scheme=>wwv_flow_api.id(31549397372157447)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
...
,p_list_item_link_text=>'Group Interchange'
...
,p_list_item_link_text=>'Deactivate '
...
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'1,32,33,34,36,37,38,40'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(31793037833216199)
,p_list_item_display_sequence=>160
,p_list_item_link_text=>'Account Types'
,p_list_item_link_target=>'f?p=&APP_ID.:32:&SESSION.::&DEBUG.'
,p_parent_list_item_id=>wwv_flow_api.id(30684284930176491)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'32'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(31804945839313440)
,p_list_item_display_sequence=>170
,p_list_item_link_text=>'Journal Types'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(31822930337398175)
,p_list_item_display_sequence=>180
,p_list_item_link_text=>'Journal'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(31835804792457299)
,p_list_item_display_sequence=>190
,p_list_item_link_text=>'Journal Items'
,p_list_item_link_target=>'f?p=&APP_ID.:37:&SESSION.::&DEBUG.::::'
,p_parent_list_item_id=>wwv_flow_api.id(30684284930176491)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(32603562163690209)
...
,p_security_scheme=>wwv_flow_api.id(30935547790298660)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'1,24,36'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(32070659551551592)
,p_list_item_display_sequence=>200
,p_list_item_link_text=>'Top Groups'
,p_list_item_link_target=>'f?p=&APP_ID.:24:&SESSION.::&DEBUG.::::'
,p_parent_list_item_id=>wwv_flow_api.id(30691053992344776)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'24'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(32574586210115994)
,p_list_item_display_sequence=>220
,p_list_item_link_text=>'All Members'
...
,p_list_item_link_text=>'Activate Groups'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(32149752583677635)
,p_list_item_display_sequence=>210
,p_list_item_link_text=>'Settings'
,p_list_item_link_target=>'f?p=&APP_ID.:39:&SESSION.::&DEBUG.::P39_ID:1:'
,p_parent_list_item_id=>wwv_flow_api.id(30873814812470194)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list(
...
,p_name=>'Credit Officer Only'
,p_scheme_type=>'NATIVE_FUNCTION_BODY'
,p_attribute_01=>'return auth.user_role(:app_user) in (''credit officer'');'
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(31549397372157447)
,p_name=>'Admin/Credit Officer'
,p_scheme_type=>'NATIVE_FUNCTION_BODY'
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(31842162657827625)
,p_lov_name=>'ACCOUNTS'
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(31802093841242362)
,p_lov_name=>'ACCOUNT_TYPES'
,p_lov_query=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select name as d,',
'       id as r',
'  from account_type',
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(32587600559249823)
,p_lov_name=>'CREDIT_OFFICER_BY_EMAIL'
,p_lov_query=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select name || '' - ''|| email as d,',
'       email as r',
'  from users where role_id=3',
' order by 1'))
);
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(31986186718890787)
,p_lov_name=>'JOURNAL'
,p_lov_query=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select name as d,',
'       id as r',
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(31841379443795236)
,p_lov_name=>'JOURNAL_TYPES'
,p_lov_query=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select name as d,',
'       id as r',
'  from journal_type',
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(31869380412227175)
,p_lov_name=>'LOAN TITLE'
,p_lov_query=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select title, Id',
'from Loan',
'order by title'))
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(31674125145879241)
,p_lov_name=>'MEMBERS'
,p_lov_query=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'SELECT FirstName||'' ''||LastName as d, Id',
'from Members',
'order by d'))
);
wwv_flow_api.create_list_of_values(
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(31813314490351964)
,p_lov_name=>'TRANSACTION_TYPE'
,p_lov_query=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select name as d,',
'       id as r',
...
'  ',
'  union all ',
'  select ''Individual Account'' d,0 r from dual ',
' order by 1'))
);
wwv_flow_api.create_list_of_values(
...
'  ',
'union all select ''Individual Account'' d, 0 r from dual',
'order by 1,2'))
);
wwv_flow_api.create_list_of_values(
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31514105068190687)
,p_parent_id=>wwv_flow_api.id(30924685043055166)
,p_short_name=>'Deactivate'
,p_link=>'f?p=&APP_ID.:21:&SESSION.::&DEBUG.:::'
,p_page_id=>21
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31514315694198557)
,p_parent_id=>wwv_flow_api.id(30924685043055166)
,p_short_name=>'Group Interchange'
,p_link=>'f?p=&APP_ID.:4:&SESSION.::&DEBUG.:::'
,p_page_id=>4
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31532461350602851)
,p_parent_id=>wwv_flow_api.id(30679751915989997)
,p_short_name=>'Individual '
,p_long_name=>'Individual Accounts'
,p_link=>'f?p=&APP_ID.:11:&SESSION.::&DEBUG.:::'
,p_page_id=>11
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31536029418677523)
,p_parent_id=>wwv_flow_api.id(30924685043055166)
,p_short_name=>'Collections'
,p_long_name=>'Manage Collections'
,p_link=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.:::'
,p_page_id=>3
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31538638673753001)
,p_parent_id=>wwv_flow_api.id(30679751915989997)
,p_short_name=>'Loans'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31539904585772423)
,p_parent_id=>wwv_flow_api.id(31538638673753001)
,p_short_name=>'Disbursed'
,p_link=>'f?p=&APP_ID.:14:&SESSION.::&DEBUG.:::'
,p_page_id=>14
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31542947231029135)
,p_parent_id=>wwv_flow_api.id(31552444156223651)
,p_short_name=>' Activate Groups'
,p_link=>'f?p=&APP_ID.:22:&SESSION.::&DEBUG.:::'
,p_page_id=>22
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31547350443383557)
,p_parent_id=>wwv_flow_api.id(30679751915989997)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31547685817400537)
,p_parent_id=>wwv_flow_api.id(30679751915989997)
,p_short_name=>'Change Password'
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31552444156223651)
,p_parent_id=>wwv_flow_api.id(30679751915989997)
,p_short_name=>'Operations'
,p_link=>'f?p=&APP_ID.:25:&SESSION.::&DEBUG.:::'
,p_page_id=>25
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31555529318269082)
,p_parent_id=>wwv_flow_api.id(30679751915989997)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31682420319914195)
,p_parent_id=>wwv_flow_api.id(31532461350602851)
,p_short_name=>'Individual Accounts'
,p_link=>'f?p=&APP_ID.:10:&SESSION.::&DEBUG.:::'
,p_page_id=>10
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31726063471879595)
,p_parent_id=>wwv_flow_api.id(31538638673753001)
,p_short_name=>'Manage Loans'
,p_link=>'f?p=&APP_ID.:13:&SESSION.::&DEBUG.:::'
,p_page_id=>13
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31790980319178064)
,p_parent_id=>wwv_flow_api.id(30679751915989997)
...
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31801301959216210)
,p_parent_id=>wwv_flow_api.id(31790980319178064)
,p_short_name=>'Account Types'
,p_link=>'f?p=&APP_ID.:32:&SESSION.'
,p_page_id=>32
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31810563593313448)
,p_parent_id=>wwv_flow_api.id(31790980319178064)
,p_short_name=>'Journal Types'
,p_link=>'f?p=&APP_ID.:33:&SESSION.'
,p_page_id=>33
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31829030421398179)
,p_parent_id=>wwv_flow_api.id(31790980319178064)
,p_short_name=>'Journal'
,p_link=>'f?p=&APP_ID.:34:&SESSION.'
,p_page_id=>34
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31830203192398180)
,p_parent_id=>wwv_flow_api.id(31829030421398179)
,p_short_name=>'Manage Journal'
,p_link=>'f?p=&APP_ID.:35:&SESSION.'
,p_page_id=>35
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31907530800574414)
,p_parent_id=>wwv_flow_api.id(31539904585772423)
,p_short_name=>'Manage Disbursed Loan'
,p_link=>'f?p=&APP_ID.:17:&SESSION.::&DEBUG.:::'
,p_page_id=>17
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31967296341626809)
,p_parent_id=>wwv_flow_api.id(31790980319178064)
,p_short_name=>'Journal Items'
,p_link=>'f?p=&APP_ID.:37:&SESSION.::&DEBUG.:::'
,p_page_id=>37
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(31968448966626810)
,p_parent_id=>wwv_flow_api.id(31967296341626809)
,p_short_name=>'Manage Journal Item'
,p_link=>'f?p=&APP_ID.:38:&SESSION.::&DEBUG.:::'
,p_page_id=>38
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(32071848079551596)
,p_parent_id=>wwv_flow_api.id(31555529318269082)
,p_short_name=>'Top Groups'
,p_link=>'f?p=&APP_ID.:24:&SESSION.::&DEBUG.:::'
,p_page_id=>24
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(32148367824634275)
,p_parent_id=>wwv_flow_api.id(31552444156223651)
,p_short_name=>'System Config'
,p_link=>'f?p=&APP_ID.:39:&SESSION.'
,p_page_id=>39
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(32582764757116005)
,p_parent_id=>wwv_flow_api.id(31555529318269082)
,p_short_name=>'Member Portfilio'
,p_link=>'f?p=&APP_ID.:36:&SESSION.'
,p_page_id=>36
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(32604788151690211)
,p_parent_id=>wwv_flow_api.id(31790980319178064)
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(31766967823222187)
,p_theme_id=>42
,p_name=>'Login Ruby'
,p_is_popup=>false
,p_javascript_file_urls=>'http://novajii.com/img/ruby/assets/login.css'
,p_javascript_code_onload=>'apex.theme42.initializePage.appLogin();'
,p_css_file_urls=>'http://novajii.com/img/ruby/assets/login.css'
,p_header_template=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<!doctype html>',
'<meta http-equiv="x-ua-compatible" content="IE=edge" />',
'',
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31767368998222191)
,p_page_template_id=>wwv_flow_api.id(31766967823222187)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(31767808489222191)
,p_page_template_id=>wwv_flow_api.id(31766967823222187)
,p_name=>'Body Header'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>false
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(32035125325037669)
,p_template_name=>'Hyperlink (New Line)'
,p_template=>'<br/><a class="#BUTTON_CSS_CLASSES#" href="#LINK#">#LABEL#</a>'
,p_theme_class_id=>0
,p_theme_id=>42
);
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(32041421375504428)
,p_template_name=>'Hyperlink ( New Column )'
,p_template=>'<a class="#BUTTON_CSS_CLASSES#" href="#LINK#">#LABEL#</a>'
,p_theme_class_id=>0
,p_theme_id=>42
);
end;
...
,p_css_file_urls=>'http://novajii.com/img/ruby/assets/customize.css'
,p_nav_bar_type=>'LIST'
...
,p_plug_name=>'Dashboard'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader:t-Region--scrollBody:t-Form--labelsAbove'
,p_plug_template=>wwv_flow_api.id(31261378455831956)
,p_plug_display_sequence=>30
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_display_point=>'BODY'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_required_role=>wwv_flow_api.id(31549397372157447)
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31976215577638039)
,p_plug_name=>'Admin Section'
,p_region_template_options=>'t-Region--noPadding:js-showMaximizeButton:t-Region--hideHeader:t-Region--scrollBody:t-Form--labelsAbove'
,p_plug_template=>wwv_flow_api.id(31261378455831956)
,p_plug_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_display_point=>'BODY'
...
,p_plug_name=>'Reporting & Portfolio'
,p_parent_plug_id=>wwv_flow_api.id(31976215577638039)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31974615792638023)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(31974464198638021)
,p_button_name=>'NEW_GROUP'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
...
,p_button_css_classes=>'link'
,p_grid_new_row=>'Y'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31975491196638031)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(31974573425638022)
,p_button_name=>'NEW_LOAN'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31976820374638045)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(31976358631638040)
,p_button_name=>'ACCOUNTS'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Chart of Accounts'
,p_button_position=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31975193246638028)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(31974464198638021)
,p_button_name=>'BROWSE_GROUPS'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Browse Groups'
,p_button_position=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31975542720638032)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(31974573425638022)
,p_button_name=>'BROWSE_LOANS'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Loans to Disburse'
,p_button_position=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31976492079638041)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(31976358631638040)
,p_button_name=>'ACCOUNT_TYPES'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Account Types'
,p_button_position=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31977188891638048)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(31976952502638046)
,p_button_name=>'TOP_GROUPS'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Top Groups'
,p_button_position=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31974891692638025)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(31974464198638021)
,p_button_name=>'GROUP_COLLECTIONS'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Group Collections'
,p_button_position=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31975669775638033)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(31974573425638022)
,p_button_name=>'ACTIVE_LOANS'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Running Loans (Disbursed)'
,p_button_position=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31976566178638042)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(31976358631638040)
,p_button_name=>'JOURNAL_TYPES'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Journal Types'
,p_button_position=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(32495788407014523)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(31976952502638046)
,p_button_name=>'PORTFOLIO'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Member Portfolio'
,p_button_position=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31975285370638029)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(31974464198638021)
,p_button_name=>'GROUP_INTERCHANGE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Group Interchange'
,p_button_position=>'BODY'
,p_button_redirect_url=>'f?p=&APP_ID.:14:&SESSION.::&DEBUG.:RP::'
,p_button_css_classes=>'link'
,p_grid_new_row=>'N'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31975768943638034)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(31974923134638026)
,p_button_name=>'INDIVIDUAL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Individual Accounts'
,p_button_position=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31976604330638043)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(31976358631638040)
,p_button_name=>'JOURNAL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'General Journal'
,p_button_position=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(32078241612713508)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(31976952502638046)
,p_button_name=>'TOP_CREDIT_OFFICERS'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Top Credit Officers'
,p_button_position=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31975399003638030)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(31974464198638021)
,p_button_name=>'DEACTIVATE_GROUP'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'De-activate Group'
,p_button_position=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31975856347638035)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(31974923134638026)
,p_button_name=>'ADD_INDIVIDUAL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'New Individual Account'
,p_button_position=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31976794606638044)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(31976358631638040)
,p_button_name=>'JOURNAL_ITEMS'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Journal Items'
,p_button_position=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(32078379668713509)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(31976952502638046)
,p_button_name=>'MORE_REPORTS'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31975932773638036)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_api.id(31975026885638027)
,p_button_name=>'ADD_MEMBER'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'New Member'
,p_button_position=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31976100126638038)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_api.id(31974464198638021)
,p_button_name=>'NEW_MEMBER'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(32495698799014522)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_api.id(31976358631638040)
,p_button_name=>'TRIAL_BALANCE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Trial Balance'
,p_button_position=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31976028159638037)
,p_button_sequence=>70
,p_button_plug_id=>wwv_flow_api.id(31975026885638027)
,p_button_name=>'BROWSE_MEMBERS'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'View All Members'
,p_button_position=>'BODY'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20160622111942'
);
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(31635035004788033)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(31635254498788035)
,p_query_column_id=>2
,p_column_alias=>'NAME'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(31635867724788041)
,p_query_column_id=>3
,p_column_alias=>'DESCRIPTION'
,p_column_display_sequence=>3
,p_column_heading=>'Description of Roles'
,p_use_as_row_header=>'N'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20160624132143'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31487163102085717)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31490198450085747)
...
'where Group_Id = :P3_GROUPS and credit_officer_id=auth.user_id(:app_user)'))
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(31633989525788022)
...
,p_owner=>'SUPPORT'
,p_internal_uid=>31633989525788022
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31634028321788023)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31634187263788024)
,p_db_column_name=>'SAVINGS'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Savings'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31634278456788025)
,p_db_column_name=>'LOAN_INSTALLMENT'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Loan installment'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31634301430788026)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31634409098788027)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31634511878788028)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31634614732788029)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31634706072788030)
,p_db_column_name=>'LOAN_ID'
,p_display_order=>80
,p_column_identifier=>'H'
,p_column_label=>'Related Loan'
,p_column_type=>'NUMBER'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_column_alignment=>'RIGHT'
,p_rpt_named_lov=>wwv_flow_api.id(31869380412227175)
,p_rpt_show_filter_lov=>'1'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31634856740788031)
...
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_column_alignment=>'RIGHT'
,p_rpt_named_lov=>wwv_flow_api.id(31674125145879241)
,p_rpt_show_filter_lov=>'1'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(31673283979850176)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'316733'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>50
,p_report_columns=>'ID:SAVINGS:LOAN_INSTALLMENT:GROUP_ID:COLLECTION_DATE:CREDIT_OFFICER_ID:AMOUNT:LOAN_ID:MEMBER_ID'
,p_flashback_enabled=>'N'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31632447332788007)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(31490198450085747)
,p_button_name=>'ADD'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--large'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31490305307085749)
,p_name=>'P3_GROUPS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(31490198450085747)
,p_prompt=>'Groups'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select Name, Id',
'from Groups',
'where Credit_officer_id = auth.user_id(:app_user) and DayOfWeek = :P3_DAY_OF_WEEK'))
,p_lov_cascade_parent_items=>'P3_DAY_OF_WEEK'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31635506440788038)
,p_name=>'P3_DAY_OF_WEEK'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(31490198450085747)
,p_item_default=>'app.active_day'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(30585959156216440)
,p_name=>'Refresh Page'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(31632447332788007)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(30586046991216441)
,p_event_id=>wwv_flow_api.id(30585959156216440)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(31490198450085747)
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>4
,p_user_interface_id=>wwv_flow_api.id(30678093337989972)
,p_name=>'Group Interchange'
,p_page_mode=>'NORMAL'
,p_step_title=>'Group Interchange'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_page_template_options=>'#DEFAULT#'
,p_overwrite_navigation_list=>'N'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20160624132244'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31486068523085706)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(30695683735387526)
,p_prompt=>'Secondary Group'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'return app.get_groups(:app_user,:p4_sdow,''0'');'
,p_lov_cascade_parent_items=>'P4_SDOW'
,p_ajax_optimize_refresh=>'Y'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_field_template=>wwv_flow_api.id(30672380578989951)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31635958870788042)
,p_name=>'P4_SDOW'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(30695683735387526)
,p_item_default=>'app.active_day'
,p_item_default_type=>'PLSQL_EXPRESSION'
,p_prompt=>'Secondary Day of Week'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>'WEEK_DAYS'
,p_lov=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select description as d,',
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20160624145457'
);
wwv_flow_api.create_page_plug(
...
'"CREDIT_OFFICER_ID",',
'"CREATE_DATE"',
'from "#OWNER#"."GROUPS"  where credit_officer_id= auth.user_id(:app_user)  and id = :P8_GROUP',
'  ',
''))
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_header=>'<h3>Groups</h3><br/>'
);
wwv_flow_api.create_worksheet(
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31758704828431007)
,p_name=>'P8_DAY_OF_WEEK'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(30920955154055158)
,p_item_default=>'app.active_day'
,p_item_default_type=>'PLSQL_EXPRESSION'
,p_prompt=>'Day of week'
,p_display_as=>'NATIVE_SELECT_LIST'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31758807734431008)
,p_name=>'P8_GROUP'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(30920955154055158)
,p_prompt=>'Group'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'return app.get_groups',
'    (',
'      p_username => :app_user,',
'      p_dow   =>   :p8_day_of_week,',
'      p_except =>0',
'    );'))
,p_lov_cascade_parent_items=>'P8_DAY_OF_WEEK'
,p_ajax_optimize_refresh=>'Y'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_field_template=>wwv_flow_api.id(30672380578989951)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31487677223085722)
,p_name=>'P9_STATUS'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(30913321310055144)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31487729431085723)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Set_Status'
,p_process_sql_clob=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'begin',
'   :P9_STATUS := ''ACT'';',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(30913781592055144)
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31634923876788032)
,p_plug_name=>'Breadcrumb Bar'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20160624135521'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31487097668085716)
,p_plug_name=>'Breadcrumb Bar'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(32555809602587360)
,p_plug_name=>'Individual Members'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader:t-Region--scrollBody:t-Form--labelsAbove'
,p_plug_template=>wwv_flow_api.id(31261378455831956)
,p_plug_display_sequence=>30
,p_include_in_reg_disp_sel_yn=>'N'
...
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select "ID", ',
'upper(firstname)||'' ''||upper(lastname) fullname,',
'"TEL",',
'"EMAIL",',
'app.saving_balance(id) Savings_balance,',
'accounting.cash_security(id) cash_security,',
'app.current_loan(id) current_loan,',
'app.total_installment_by_member(id) total_installment,',
'app.outstanding_loan(id) outstanding_installment,',
'app. loan_interest_receivable(id) interest_receivable,',
'"GROUP_ID",',
'"REGISTRATION_AMOUNT"',
'from "#OWNER#"."MEMBERS" where credit_officer_id=auth.user_id(:app_user) and group_id=0  order by id desc',
'  ',
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(32556140479587362)
,p_name=>'Members'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_download_formats=>'CSV:HTML:EMAIL:XLS:PDF:RTF'
,p_owner=>'ADMIN'
,p_internal_uid=>32556140479587362
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32556222530587364)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32559836408587366)
,p_db_column_name=>'FULLNAME'
,p_display_order=>11
,p_column_identifier=>'V'
,p_column_label=>'Member '
,p_column_link=>'f?p=&APP_ID.:16:&SESSION.::&DEBUG.:RP:P16_ID:#ID#'
,p_column_linktext=>'#FULLNAME#'
,p_column_link_attr=>'style="text-decoration:underline"'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32556695891587364)
,p_db_column_name=>'TEL'
,p_display_order=>21
,p_column_identifier=>'F'
,p_column_label=>'Telephone'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32557094001587364)
,p_db_column_name=>'EMAIL'
,p_display_order=>31
,p_column_identifier=>'G'
,p_column_label=>'Email'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32557431139587364)
,p_db_column_name=>'GROUP_ID'
,p_display_order=>41
,p_column_identifier=>'K'
,p_column_label=>'Group'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32557898122587365)
,p_db_column_name=>'REGISTRATION_AMOUNT'
,p_display_order=>51
,p_column_identifier=>'M'
,p_column_label=>'Registered With'
,p_column_type=>'NUMBER'
,p_format_mask=>'999G999G999G999G990D00'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32558273332587365)
,p_db_column_name=>'SAVINGS_BALANCE'
,p_display_order=>61
,p_column_identifier=>'R'
,p_column_label=>'Savings Bal.'
,p_column_html_expression=>'<red>#SAVINGS_BALANCE#</red>'
,p_column_type=>'NUMBER'
,p_format_mask=>'999G999G999G999G990D00'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32558619017587365)
,p_db_column_name=>'CURRENT_LOAN'
,p_display_order=>71
,p_column_identifier=>'S'
,p_column_label=>'Current Loan'
,p_column_html_expression=>'<red>#CURRENT_LOAN#</red>'
,p_column_type=>'NUMBER'
,p_format_mask=>'999G999G999G999G990D00'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32559000570587365)
,p_db_column_name=>'TOTAL_INSTALLMENT'
,p_display_order=>81
,p_column_identifier=>'T'
,p_column_label=>'Total Installment'
,p_column_html_expression=>'<red>#TOTAL_INSTALLMENT#</red>'
,p_column_type=>'NUMBER'
,p_format_mask=>'999G999G999G999G990D00'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32559426131587366)
,p_db_column_name=>'OUTSTANDING_INSTALLMENT'
,p_display_order=>91
,p_column_identifier=>'U'
,p_column_label=>'Outstanding Installment'
,p_column_html_expression=>'<red>#OUTSTANDING_INSTALLMENT#</red>'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_format_mask=>'999G999G999G999G990D00'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32560236838587367)
,p_db_column_name=>'CASH_SECURITY'
,p_display_order=>101
,p_column_identifier=>'W'
,p_column_label=>'Cash Security'
,p_column_html_expression=>'<red>#CASH_SECURITY#</red>'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_format_mask=>'999G999G999G999G990D00'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32560693597587367)
,p_db_column_name=>'INTEREST_RECEIVABLE'
,p_display_order=>111
,p_column_identifier=>'X'
,p_column_label=>'Interest Receivable'
,p_column_html_expression=>'<red>#INTEREST_RECEIVABLE#</red>'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_format_mask=>'999G999G999G999G990D00'
);
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(32561000504587367)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'325611'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>50
,p_report_columns=>'ID:TEL:EMAIL:GROUP_ID:REGISTRATION_AMOUNT:SAVINGS_BALANCE:CURRENT_LOAN:TOTAL_INSTALLMENT:OUTSTANDING_INSTALLMENT:FULLNAME:CASH_SECURITY:INTEREST_RECEIVABLE'
,p_flashback_enabled=>'N'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31118276303691896)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(32555809602587360)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--large'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20160624132413'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32079148350713517)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32079226832713518)
,p_db_column_name=>'INTEREST_RECEIVABLE'
,p_display_order=>151
,p_column_identifier=>'P'
,p_column_label=>'Interest receivable'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32079393730713519)
,p_db_column_name=>'TOTAL_PAYABLE'
,p_display_order=>161
,p_column_identifier=>'Q'
,p_column_label=>'Total payable'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_format_mask=>'999G999G999G999G990D00'
);
...
,p_is_default=>'Y'
,p_display_rows=>50
,p_report_columns=>'ID:MEMBER_ID:CREDIT_OFFICER_ID:AMOUNT:EQUITY:PROCESSING_FEE:CASH_SECURITY:START_DATE:END_DATE:INTEREST_RATE:WEEKLY_REPAYMENT:GROUP_ID:TITLE:INTEREST_RECEIVABLE:TOTAL_PAYABLE'
,p_flashback_enabled=>'N'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31487222889085718)
,p_plug_name=>'Breadcrumb Bar'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20160624145020'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31635728296788040)
,p_plug_name=>'Breadcrumb bar'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31974193530638018)
,p_plug_name=>'Loan Disbursement Verification'
...
,p_plug_display_when_condition=>'return (:p13_id is not null) and (app.has_active_loan(:p13_member_id) = true);'
,p_plug_header=>'This member has an active loan. New loans can only be disbursed only when the active loan is closed'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_button(
...
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_button_condition=>'return (:p13_id is not null) and (app.has_active_loan(:p13_member_id) = false);'
...
,p_use_cache_before_default=>'NO'
,p_prompt=>'Group/Individual Account'
,p_source=>'GROUP_ID'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
'      p_except =>0',
'    );'))
,p_lov_cascade_parent_items=>'P13_DOW'
,p_ajax_optimize_refresh=>'Y'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_field_template=>wwv_flow_api.id(30672692966989952)
...
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'return app.members_lov(p_credit_officer_id => auth.user_id(:app_user),',
'                       p_group_id=> :p13_group_id);'))
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31635625349788039)
,p_name=>'P13_TITLE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(31123101218255583)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32078421373713510)
,p_name=>'P13_INTEREST_RECEIVABLE'
,p_item_sequence=>190
,p_item_plug_id=>wwv_flow_api.id(31123101218255583)
,p_use_cache_before_default=>'NO'
,p_item_default=>'0.00'
,p_prompt=>'Interest Receivable (&NGN.)'
,p_source=>'WEEKLY_REPAYMENT'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_colspan=>4
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32078527366713511)
,p_name=>'P13_TOTAL_PAYABLE'
,p_item_sequence=>200
,p_item_plug_id=>wwv_flow_api.id(31123101218255583)
,p_use_cache_before_default=>'NO'
,p_item_default=>'0.00'
,p_prompt=>'Total Payable (&NGN.)'
,p_source=>'WEEKLY_REPAYMENT'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_begin_on_new_line=>'N'
...
,p_triggering_element=>'P13_AMOUNT,P13_END_DATE'
,p_bind_type=>'bind'
...
'begin',
'',
':p13_equity := app.loan_equity(:p13_amount);',
':p13_processing_fee := app.loan_processing_fee(:p13_amount);',
':p13_duration := trunc(to_date(:p13_end_date,''DD-MON-YYYY'')-to_date(:p13_start_date,''DD-MON-YYYY''));',
':p13_cash_security := app.loan_requirement(:p13_amount);',
'p_weeks := app.weeks_between(to_date(:p13_start_date,''DD-MON-YYYY''),to_date(:p13_end_date,''DD-MON-YYYY''));',
':p13_interest_receivable := app.calculate_interest_receivable(:p13_amount,:p13_start_date,:p13_end_date,app.loan_interest_rate );',
':p13_total_payable := :p13_amount + :p13_interest_receivable;',
':p13_weekly_repayment := app.loan_weekly_repayment(:p13_total_payable,p_weeks);',
'end;'))
,p_attribute_02=>'P13_AMOUNT,P13_START_DATE,P13_END_DATE'
,p_attribute_03=>'P13_EQUITY,P13_INTEREST_RECEIVABLE,P13_PROCESSING_FEE,P13_TOTAL_PAYABLE,P13_WEEKLY_REPAYMENT,P13_CASH_SECURITY,P13_DURATION'
,p_attribute_04=>'N'
...
'',
'app.draft_loan(',
'      p_member_id => :p13_member_id,',
'      p_credit_officer_id => auth.user_id(:app_user),',
'      p_amount => :p13_amount,',
'      p_start => :p13_start_date,',
'      p_end => :p13_end_date,',
'      p_group_id => :p13_group_id,',
'      p_title => :p13_title',
'    );',
'',
'end;'))
,p_process_error_message=>'&CONTACT_ADMIN.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(31123587033255584)
,p_process_success_message=>'Draft Loan created successfully'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(32079000886713516)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Update Loan'
,p_process_sql_clob=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'begin',
'',
'-- we just delete the draft and recreate a new draft with same values',
'',
'delete from loan where id = :p13_id;',
'commit;',
'',
'-- create new draft with same values',
'',
'app.draft_loan(',
'      p_member_id => :p13_member_id,',
'      p_credit_officer_id => auth.user_id(:app_user),',
...
,p_process_error_message=>'&CONTACT_ADMIN.'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(31123697800255584)
,p_process_when=>'P13_ID'
,p_process_when_type=>'ITEM_IS_NOT_NULL'
,p_process_success_message=>'Draft Loan updated successfully'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(32078839482713514)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Delete Loan'
,p_process_sql_clob=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'delete from loan where id = :p13_id;',
'commit;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
...
,p_process_when=>'P13_ID'
,p_process_when_type=>'ITEM_IS_NOT_NULL'
,p_process_success_message=>'Loan deleted successfully'
);
wwv_flow_api.create_page_process(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20160624132700'
);
wwv_flow_api.create_page_plug(
...
'"INTEREST_RATE",',
'"WEEKLY_REPAYMENT",',
'interest_receivable,total_payable,',
'"GROUP_ID",disbursed_date ,',
'app.total_loan_installment(id) total_repaid',
'from "#OWNER#"."LOAN" ',
' where (credit_officer_id = auth.user_id(:app_user) and state = ''disbursed'') and  Group_Id = :P14_GROUP',
''))
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31973684446638013)
,p_db_column_name=>'TOTAL_REPAID'
,p_display_order=>24
,p_column_identifier=>'O'
,p_column_label=>'Total Repaid'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
,p_format_mask=>'999G999G999G999G990D00'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32080540193713531)
,p_db_column_name=>'DISBURSED_DATE'
,p_display_order=>34
,p_column_identifier=>'P'
,p_column_label=>'Disbursed date'
,p_column_type=>'DATE'
,p_column_alignment=>'CENTER'
,p_format_mask=>'DD-MON-YYYY'
,p_tz_dependent=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32080657441713532)
,p_db_column_name=>'INTEREST_RECEIVABLE'
,p_display_order=>44
,p_column_identifier=>'Q'
,p_column_label=>'Interest receivable'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32080710245713533)
,p_db_column_name=>'TOTAL_PAYABLE'
,p_display_order=>54
,p_column_identifier=>'R'
,p_column_label=>'Total payable'
...
,p_is_default=>'Y'
,p_display_rows=>50
,p_report_columns=>'ID:MEMBER_ID:CREDIT_OFFICER_ID:AMOUNT:EQUITY:PROCESSING_FEE:CASH_SECURITY:START_DATE:END_DATE:INTEREST_RATE:WEEKLY_REPAYMENT:GROUP_ID:TOTAL_REPAID:DISBURSED_DATE:INTEREST_RECEIVABLE:TOTAL_PAYABLE'
,p_flashback_enabled=>'N'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31487388996085719)
,p_plug_name=>'Breadcrumb Bar'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31758321838431003)
,p_name=>'P14_DAY_OF_WEEK'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(31181075857178969)
,p_item_default=>'app.active_day'
,p_item_default_type=>'PLSQL_EXPRESSION'
,p_prompt=>'Day of week'
,p_display_as=>'NATIVE_SELECT_LIST'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31758465226431004)
,p_name=>'P14_GROUP'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(31181075857178969)
,p_prompt=>'Group'
...
'select Name, Id',
'from Groups',
'where Credit_officer_id = auth.user_id(:app_user) and DayOfWeek = :P14_DAY_OF_WEEK'))
,p_lov_cascade_parent_items=>'P14_DAY_OF_WEEK'
,p_ajax_optimize_refresh=>'Y'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_field_template=>wwv_flow_api.id(30672380578989951)
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20160624134735'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32495102699014517)
,p_db_column_name=>'FULLNAME'
,p_display_order=>11
,p_column_identifier=>'V'
,p_column_label=>'Member '
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32079778196713523)
,p_db_column_name=>'SAVINGS_BALANCE'
,p_display_order=>61
,p_column_identifier=>'R'
,p_column_label=>'Savings Bal.'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32081880000713544)
,p_db_column_name=>'CURRENT_LOAN'
,p_display_order=>71
,p_column_identifier=>'S'
,p_column_label=>'Current Loan'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32081992629713545)
,p_db_column_name=>'TOTAL_INSTALLMENT'
,p_display_order=>81
,p_column_identifier=>'T'
,p_column_label=>'Total Installment'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32082072702713546)
,p_db_column_name=>'OUTSTANDING_INSTALLMENT'
,p_display_order=>91
,p_column_identifier=>'U'
,p_column_label=>'Outstanding Installment'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32495237874014518)
,p_db_column_name=>'CASH_SECURITY'
,p_display_order=>101
,p_column_identifier=>'W'
,p_column_label=>'Cash Security'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32495302070014519)
,p_db_column_name=>'INTEREST_RECEIVABLE'
,p_display_order=>111
,p_column_identifier=>'X'
,p_column_label=>'Interest Receivable'
...
'    (',
'      p_username => :app_user,',
'      p_dow   =>   :p15_day_of_week,',
'      p_except =>0',
'    );'))
,p_lov_cascade_parent_items=>'P15_DAY_OF_WEEK'
,p_ajax_optimize_refresh=>'Y'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_field_template=>wwv_flow_api.id(30672380578989951)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31635390649788036)
,p_name=>'P15_DAY_OF_WEEK'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(30996734880521019)
,p_item_default=>'app.active_day'
,p_item_default_type=>'PLSQL_EXPRESSION'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20160624140237'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(32082248355713548)
,p_plug_name=>'Left'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30643706521989934)
,p_plug_display_sequence=>10
...
,p_plug_header=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<h3>',
'    <span class="fa fa-user"></span>&nbsp;Member Information',
'</h3>'))
,p_attribute_01=>'N'
,p_attribute_02=>'TEXT'
,p_attribute_03=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(32493694870014502)
,p_plug_name=>'Active Loan<br/>  &P16_CURRENT_LOAN.  &NGN.'
,p_parent_plug_id=>wwv_flow_api.id(32082248355713548)
,p_icon_css_classes=>'fa-credit-card'
,p_region_template_options=>'#DEFAULT#:t-Alert--horizontal:t-Alert--customIcons:t-Alert--info'
,p_plug_template=>wwv_flow_api.id(30642275121989930)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(32493854435014504)
,p_plug_name=>'Interest Receivable<br/>  &P16_INTEREST.  &NGN.'
,p_parent_plug_id=>wwv_flow_api.id(32082248355713548)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(32494130267014507)
,p_plug_name=>'Right'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30643706521989934)
,p_plug_display_sequence=>40
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(32079849232713524)
,p_name=>'Savings Report'
...
,p_display_point=>'BODY'
,p_source=>'select member_id,savings,collection_date,credit_officer_id,group_id,upper(description) description from member_savings where member_id = :p16_id order by collection_date desc'
,p_source_type=>'NATIVE_SQL_REPORT'
,p_display_when_condition=>'P16_ID'
,p_display_condition_type=>'ITEM_IS_NOT_NULL'
,p_header=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<h3>',
'    <span class="fa fa-bar-chart"></span>&nbsp;Savings History',
'</h3>'))
,p_ajax_enabled=>'Y'
,p_query_row_template=>wwv_flow_api.id(30660670762989944)
,p_query_num_rows=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(32079918980713525)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(32080004715713526)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(32080171999713527)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(32080266564713528)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(32494920670014515)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(32080433028713530)
,p_query_column_id=>6
,p_column_alias=>'DESCRIPTION'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(32494212276014508)
,p_name=>'Installments Paid'
,p_parent_plug_id=>wwv_flow_api.id(32494130267014507)
,p_template=>wwv_flow_api.id(31261378455831956)
,p_display_sequence=>40
,p_include_in_reg_disp_sel_yn=>'N'
...
,p_display_point=>'BODY'
,p_source=>'select member_id,loan_installment,collection_date,group_id,credit_officer_id from member_installment where member_id = :p16_id order by collection_date desc'
,p_source_type=>'NATIVE_SQL_REPORT'
,p_display_when_condition=>'P16_ID'
,p_display_condition_type=>'ITEM_IS_NOT_NULL'
,p_header=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<h3>',
'    <span class="fa fa-bar-chart"></span>&nbsp;Loan Installments',
'</h3>'))
,p_ajax_enabled=>'Y'
,p_query_row_template=>wwv_flow_api.id(30660670762989944)
,p_query_num_rows=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(32494719687014513)
,p_query_column_id=>1
,p_column_alias=>'MEMBER_ID'
,p_column_display_sequence=>3
,p_column_heading=>'Member'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(32494865806014514)
,p_query_column_id=>2
,p_column_alias=>'LOAN_INSTALLMENT'
,p_column_display_sequence=>5
,p_column_heading=>'Loan installment'
,p_use_as_row_header=>'N'
,p_column_format=>'999G999G999G999G990D00'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(32494548278014511)
,p_query_column_id=>3
,p_column_alias=>'COLLECTION_DATE'
,p_column_display_sequence=>1
,p_column_heading=>'Collection date'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(32495062151014516)
,p_query_column_id=>4
,p_column_alias=>'GROUP_ID'
,p_column_display_sequence=>4
,p_column_heading=>'Group '
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(32494612088014512)
,p_query_column_id=>5
,p_column_alias=>'CREDIT_OFFICER_ID'
,p_column_display_sequence=>2
,p_hidden_column=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31973511479638012)
,p_name=>'P16_CREDIT_OFFICER_ID'
,p_item_sequence=>280
,p_item_plug_id=>wwv_flow_api.id(30985999412521005)
,p_use_cache_before_default=>'NO'
,p_item_default=>'auth.user_id(:app_user)'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32078167980713507)
,p_name=>'P16_PASSPORT_FEE'
,p_item_sequence=>270
,p_item_plug_id=>wwv_flow_api.id(30985999412521005)
,p_use_cache_before_default=>'NO'
,p_source=>'PASSPORT_FEE'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
,p_display_when=>'P16_ID'
,p_display_when_type=>'ITEM_IS_NULL'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32079634145713522)
,p_name=>'P16_SAVING_BALANCE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(30985999412521005)
,p_item_default=>'to_char(app.saving_balance(:p16_id),''999,999,999.99'')'
,p_item_default_type=>'PLSQL_EXPRESSION'
,p_format_mask=>'999G999G999G999G990D00'
,p_source=>'to_char(app.saving_balance(:p16_id),''999,999,999.99'')'
...
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(30985999412521005)
,p_item_default=>'to_char(accounting.cash_security(:p16_id),''999,999,999.99'')'
,p_item_default_type=>'PLSQL_EXPRESSION'
,p_format_mask=>'999G999G999G999G990D00'
,p_source=>'to_char(accounting.cash_security(:p16_id),''999,999,999.99'')'
,p_source_type=>'FUNCTION'
,p_display_as=>'NATIVE_HIDDEN'
,p_display_when=>'P16_ID'
,p_display_when_type=>'ITEM_IS_NOT_NULL'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32493568428014501)
,p_name=>'P16_CURRENT_LOAN'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(30985999412521005)
,p_item_default=>'to_char(app.current_loan(:p16_id),''999,999,999.99'')'
,p_item_default_type=>'PLSQL_EXPRESSION'
,p_format_mask=>'999G999G999G999G990D00'
,p_source=>'to_char(app.current_loan(:p16_id),''999,999,999.99'')'
,p_source_type=>'FUNCTION'
,p_display_as=>'NATIVE_HIDDEN'
,p_display_when=>'P16_ID'
,p_display_when_type=>'ITEM_IS_NOT_NULL'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32493775081014503)
,p_name=>'P16_INTEREST'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(30985999412521005)
,p_item_default=>'to_char(app.loan_interest_receivable(:p16_id),''999,999,999.99'')'
,p_item_default_type=>'PLSQL_EXPRESSION'
,p_format_mask=>'999G999G999G999G990D00'
,p_source=>'to_char(app.loan_interest_receivable(:p16_id),''999,999,999.99'')'
,p_source_type=>'FUNCTION'
,p_display_as=>'NATIVE_HIDDEN'
,p_display_when=>'P16_ID'
,p_display_when_type=>'ITEM_IS_NOT_NULL'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32493946178014505)
,p_name=>'P16_OUTSTANDING'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(30985999412521005)
,p_item_default=>'to_char(app.app.outstanding_loan(:p16_id),''999,999,999.99'')'
,p_item_default_type=>'PLSQL_EXPRESSION'
,p_format_mask=>'999G999G999G999G990D00'
,p_source=>'to_char(app.outstanding_loan(:p16_id),''999,999,999.99'')'
,p_source_type=>'FUNCTION'
,p_display_as=>'NATIVE_HIDDEN'
,p_display_when=>'P16_ID'
,p_display_when_type=>'ITEM_IS_NOT_NULL'
...
':P16_PASSport_FEE := app.passport_fees;',
'',
':p16_min_saving := :p16_registration_amount - (',
'    :p16_passbook_charge+:p16_registration_fee+:p16_idcard_fee + :p16_passport_fee );',
'',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20160624135211'
);
wwv_flow_api.create_report_region(
...
,p_display_point=>'BODY'
,p_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select  loan_installment,group_id,collection_date,credit_officer_id,loan_id, member_id ',
'from member_collection where loan_id = :p17_id'))
,p_source_type=>'NATIVE_SQL_REPORT'
,p_header=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<h3>',
'    Loan Repayments',
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(30586367806216444)
,p_query_column_id=>1
,p_column_alias=>'LOAN_INSTALLMENT'
,p_column_display_sequence=>2
,p_column_heading=>'Installment Paid'
,p_use_as_row_header=>'N'
,p_column_format=>'999G999G999G999G990D00'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(30586457032216445)
,p_query_column_id=>2
,p_column_alias=>'GROUP_ID'
,p_column_display_sequence=>3
,p_column_heading=>'Related Group'
,p_use_as_row_header=>'N'
,p_disable_sort_column=>'N'
,p_display_as=>'TEXT_FROM_LOV'
,p_named_lov=>wwv_flow_api.id(30938453948395839)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(30586586302216446)
,p_query_column_id=>3
,p_column_alias=>'COLLECTION_DATE'
,p_column_display_sequence=>4
,p_column_heading=>'Collection date'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(30586648914216447)
,p_query_column_id=>4
,p_column_alias=>'CREDIT_OFFICER_ID'
,p_column_display_sequence=>5
...
,p_disable_sort_column=>'N'
,p_display_as=>'TEXT_FROM_LOV'
,p_named_lov=>wwv_flow_api.id(30934190727227543)
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(30586754224216448)
,p_query_column_id=>6
,p_column_alias=>'MEMBER_ID'
,p_column_display_sequence=>6
,p_column_heading=>'Member'
...
,p_disable_sort_column=>'N'
,p_display_as=>'TEXT_FROM_LOV'
,p_named_lov=>wwv_flow_api.id(31212944602298775)
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31758605201431006)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Enter Collection'
,p_button_position=>'REGION_TEMPLATE_CREATE'
,p_button_redirect_url=>'f?p=&APP_ID.:18:&SESSION.::&DEBUG.:18:P18_ID:&P17_ID.'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31973860613638015)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(31190238362231819)
,p_button_name=>'CLOSE'
,p_button_action=>'SUBMIT'
...
'begin ',
'',
'select principal into p_princ from loan where id = :p17_id;',
'',
'return app.total_loan_installment(:p17_id) >= p_princ;',
'',
'end;'))
,p_button_condition_type=>'FUNCTION_BODY'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(31974026013638017)
,p_branch_name=>'Go to Loans'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31973792414638014)
,p_name=>'P17_TOTAL_REPAID'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(31190238362231819)
,p_item_default=>'to_char(app.total_loan_installment(:p17_id),''999,999,999.99'')'
,p_item_default_type=>'PLSQL_EXPRESSION'
,p_prompt=>'Total repaid'
,p_format_mask=>'999G999G999G999G990D00'
,p_source=>'to_char(app.total_loan_installment(:p17_id),''999,999,999.99'')'
,p_source_type=>'FUNCTION'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_display_when=>'P17_ID'
,p_display_when_type=>'ITEM_IS_NOT_NULL'
,p_field_template=>wwv_flow_api.id(30672486835989951)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32080834675713534)
,p_name=>'P17_INTEREST_RECEIVABLE'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(31190238362231819)
,p_use_cache_before_default=>'NO'
,p_item_default=>'0.00'
,p_prompt=>'Interest Receivable'
,p_format_mask=>'999G999G999G999G990D00'
,p_source=>'INTEREST_RECEIVABLE'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>32
,p_begin_on_new_line=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31973966838638016)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Close Loan'
,p_process_sql_clob=>'app.close_loan(:p17_id);'
,p_process_error_message=>'Unable to close loan. Please contact administrator'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(31973860613638015)
,p_process_success_message=>'<p>Loan closed successfully</p>'
);
end;
/
...
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(30641885972989930)
,p_page_template_options=>'#DEFAULT#'
,p_dialog_height=>'350'
,p_dialog_chained=>'Y'
,p_overwrite_navigation_list=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30586127333216442)
,p_name=>'P18_COLLECTION_DATE'
,p_item_sequence=>50
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(30586883308216449)
,p_validation_name=>'Check Collection Amount'
,p_validation_sequence=>10
,p_validation=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'declare ',
'',
...
'begin',
'',
'select * into p_loan from loan where id = :p18_id;',
'',
'if :p18_amount < p_loan.weekly_repayment then',
'  return ''Amount must be at least Weekly Installment of ''||to_char(p_loan.weekly_repayment,''999,999,999.99'');',
'',
'else ',
'return null;',
'',
...
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(31224000879386610)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
...
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Register Repayment'
,p_process_sql_clob=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'app.register_repayment(',
'    p_id => :p18_id,',
'    p_amount_in => :p18_amount,',
'    p_collection_date_in => :p18_collection_date,',
'    p_credit_officer_id_in => auth.user_id(:app_user));'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31488063265085726)
,p_plug_name=>'Breadcrumb Bar'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
,p_plug_display_point=>'BODY'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_header=>'<H3>Change Password</H3><BR/><br/>'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31487953611085725)
,p_plug_name=>'Breadcrumb Bar'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
wwv_flow_api.create_page(
 p_id=>21
,p_user_interface_id=>wwv_flow_api.id(30678093337989972)
,p_name=>'Deactivate Groups'
,p_page_mode=>'NORMAL'
,p_step_title=>'Deactivate Groups'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_page_template_options=>'#DEFAULT#'
,p_required_role=>wwv_flow_api.id(31549397372157447)
,p_overwrite_navigation_list=>'N'
,p_page_is_public_y_n=>'N'
,p_protection_level=>'C'
,p_cache_mode=>'NOCACHE'
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20160624132320'
);
wwv_flow_api.create_report_region(
...
'from Groups',
'where Credit_Officer_id = auth.user_id(:app_user) and Id = :P21_GROUP',
'order by Name'))
,p_source_type=>'NATIVE_TABFORM'
,p_header=>'<h3>Deactivate Groups</h3>'
,p_ajax_enabled=>'Y'
,p_query_row_template=>wwv_flow_api.id(30660670762989944)
,p_query_num_rows=>5
,p_query_options=>'DERIVED_REPORT_COLUMNS'
...
,p_inline_lov=>'STATIC:Active;ACT,Deactivated;DEA'
,p_lov_show_nulls=>'NO'
,p_derived_column=>'N'
,p_lov_display_extra=>'NO'
,p_include_in_export=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31636614584788049)
,p_name=>'P21_DAY_OF_WEEK'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(31440739422301320)
,p_item_default=>'app.active_day'
,p_item_default_type=>'PLSQL_EXPRESSION'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31636792492788050)
,p_name=>'P21_GROUP'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(31440739422301320)
,p_prompt=>'Group'
...
'select Name, Id',
'from Groups',
'where (Credit_officer_id = auth.user_id(:app_user) and DayOfWeek = :P21_DAY_OF_WEEK) and (status = ''ACT'')'))
,p_lov_cascade_parent_items=>'P21_DAY_OF_WEEK'
,p_ajax_optimize_refresh=>'Y'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_field_template=>wwv_flow_api.id(30672380578989951)
...
wwv_flow_api.create_page(
 p_id=>22
,p_user_interface_id=>wwv_flow_api.id(30678093337989972)
,p_name=>' Activate Groups'
,p_page_mode=>'NORMAL'
,p_step_title=>' Activate Groups'
...
,p_header=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<h3>',
'    Deactivate and Activate Groups',
'</h3><br/>'))
,p_ajax_enabled=>'Y'
,p_query_row_template=>wwv_flow_api.id(30660670762989944)
,p_query_num_rows=>5
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31487597377085721)
,p_plug_name=>'Breadcrumb Bar'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31758123496431001)
,p_name=>'P22_DAY_OF_WEEK'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(31474035752386469)
,p_prompt=>'Day of  the week'
,p_display_as=>'NATIVE_SELECT_LIST'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31758230066431002)
,p_name=>'P22_GROUP'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(31474035752386469)
,p_prompt=>'Group'
...
'Select Name, Id',
'from Groups',
'where DayOfWeek = :P22_DAY_OF_WEEK',
'order by Name'))
,p_lov_cascade_parent_items=>'P22_DAY_OF_WEEK'
,p_ajax_optimize_refresh=>'Y'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_field_template=>wwv_flow_api.id(30672380578989951)
...
,p_prompt=>'Enter Your Username / Email'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_field_template=>wwv_flow_api.id(30672380578989951)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(31487812677085724)
,p_validation_name=>'Check Email'
,p_validation_sequence=>10
,p_validation=>'Select Email from Users where Email = :P23_EMAIL'
,p_validation_type=>'EXISTS'
,p_error_message=>'&P23_EMAIL. does not exist.'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(31443582412301348)
,p_associated_item=>wwv_flow_api.id(31443498269301347)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31487438492085720)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Push Mail Queu'
...
wwv_flow_api.create_page(
 p_id=>24
,p_user_interface_id=>wwv_flow_api.id(30678093337989972)
,p_name=>'Top Group Reports'
,p_page_mode=>'NORMAL'
,p_step_title=>'Top Group Reports'
,p_step_sub_title=>'Top Group Savings'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_page_template_options=>'#DEFAULT#'
,p_overwrite_navigation_list=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(32071471111551595)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(32072073899551596)
,p_plug_name=>'Top Group Savings'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader:t-Region--scrollBody:t-Form--labelsAbove'
,p_plug_template=>wwv_flow_api.id(31261378455831956)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select t.GROUP_ID,',
'       t.TOTAL_SAVING,g.name ',
'  from TOP_GROUP_SAVINGS t,groups g where t.group_id=g.id'))
...
'</h3>'))
,p_attribute_01=>'NAME'
,p_attribute_02=>'TOTAL_SAVING'
,p_attribute_05=>'Top Group Savings'
,p_attribute_06=>'VERTICAL,SIDE-BY-SIDE'
,p_attribute_08=>'Group'
,p_attribute_09=>'Total Savings'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(32077668376713502)
,p_plug_name=>'Top Group Installments'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader:t-Region--scrollBody:t-Form--labelsAbove'
,p_plug_template=>wwv_flow_api.id(31261378455831956)
,p_plug_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'N'
...
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select t.GROUP_ID,',
'       t.TOTAL_installment,g.name ',
'  from TOP_GROUP_installments t,groups g where t.group_id=g.id'))
,p_plug_source_type=>'PLUGIN_COM.ORACLE.APEX.D3.BARCHART'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_query_no_data_found=>'No data found'
,p_plug_header=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'<h3>',
'    Top Group Installments',
'</h3>'))
,p_attribute_01=>'NAME'
,p_attribute_02=>'TOTAL_INSTALLMENT'
,p_attribute_05=>'Top Group Installments'
,p_attribute_06=>'VERTICAL,SIDE-BY-SIDE'
,p_attribute_08=>'Group'
,p_attribute_09=>'Total Installment'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31552044125223650)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31554119728260313)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31555179612269082)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31556202489282594)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
,p_page_mode=>'MODAL'
,p_step_title=>'Manage Group Collection'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_step_template=>wwv_flow_api.id(30641885972989930)
,p_page_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31632565489788008)
,p_plug_name=>'Group Collection'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader:t-Region--noBorder:t-Region--scrollBody:t-Form--labelsAbove'
,p_plug_template=>wwv_flow_api.id(31261378455831956)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_display_point=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(30585559065216436)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(31632565489788008)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--large'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31633197040788014)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(31632565489788008)
,p_button_name=>'SUBMIT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(30585641665216437)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(31632565489788008)
,p_button_name=>'SUBMIT_ANOTHER'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#:t-Button--large'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Submit and Add Another'
,p_button_position=>'REGION_TEMPLATE_CREATE'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(30585864786216439)
,p_branch_name=>'Reload Page'
,p_branch_action=>'f?p=&APP_ID.:29:&SESSION.::&DEBUG.:RP::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(30585641665216437)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31632609263788009)
,p_name=>'P29_DAY_OF_WEEK'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(31632565489788008)
,p_prompt=>'Day of the week'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>'WEEK_DAYS'
,p_lov=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31632836852788011)
,p_name=>'P29_GROUP'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(31632565489788008)
,p_prompt=>'Group'
...
'    (',
'      p_username => :app_user,',
'      p_dow   =>   :p29_day_of_week,',
'      p_except =>0',
'    );'))
,p_lov_cascade_parent_items=>'P29_DAY_OF_WEEK'
,p_ajax_optimize_refresh=>'Y'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_field_template=>wwv_flow_api.id(30672380578989951)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31632968641788012)
,p_name=>'P29_MEMBER'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(31632565489788008)
,p_prompt=>'Members'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'select firstname as d, id as r from members where group_id=:p29_group order by 1'
,p_lov_cascade_parent_items=>'P29_GROUP'
,p_ajax_optimize_refresh=>'Y'
,p_cHeight=>1
,p_field_template=>wwv_flow_api.id(30672380578989951)
,p_item_template_options=>'#DEFAULT#:t-Form-fieldContainer--stretchInputs'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31633046584788013)
,p_name=>'P29_AMOUNT'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(31632565489788008)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31633324753788016)
,p_name=>'P29_COLLECTION_DATE'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(31632565489788008)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31636153424788044)
,p_name=>'P29_WEEKLY_REPAYMENT'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(31632565489788008)
,p_prompt=>'Expected Loan Installment'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_field_template=>wwv_flow_api.id(30672380578989951)
,p_item_template_options=>'#DEFAULT#:t-Form-fieldContainer--stretchInputs:t-Form-fieldContainer--xlarge'
,p_attribute_01=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31636244216788045)
,p_name=>'P29_SAVINGS'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(31632565489788008)
,p_prompt=>'Computed Savings'
,p_display_as=>'NATIVE_DISPLAY_ONLY'
,p_begin_on_new_line=>'N'
,p_field_template=>wwv_flow_api.id(30672380578989951)
,p_item_template_options=>'#DEFAULT#:t-Form-fieldContainer--xlarge'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(31633201908788015)
,p_validation_name=>'CheckCollection Amount'
,p_validation_sequence=>10
,p_validation=>'return app.check_collection_amount(:p29_member,:p29_amount);'
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_error_message=>'Invalid amount'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(31633197040788014)
,p_associated_item=>wwv_flow_api.id(31633046584788013)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(31633632292788019)
,p_validation_name=>'check date'
,p_validation_sequence=>20
,p_validation=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'if to_date(:p29_collection_date,''DD-MON-YYYY'') > sysdate then',
'return ''Collection date cannot be greater than today'';',
'else return null;',
'end if;'))
,p_validation_type=>'FUNC_BODY_RETURNING_ERR_TEXT'
,p_error_message=>'Imvalid date'
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(31633197040788014)
,p_associated_item=>wwv_flow_api.id(31633324753788016)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(31636571883788048)
,p_validation_name=>'Check amount'
,p_validation_sequence=>30
,p_validation=>':P29_AMOUNT > 0'
,p_validation_type=>'SQL_EXPRESSION'
,p_error_message=>'Amount field cannot be less then or equals to 0 '
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(31633197040788014)
,p_associated_item=>wwv_flow_api.id(31633046584788013)
,p_error_display_location=>'INLINE_WITH_FIELD'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31636384485788046)
,p_name=>'Set Expected Loan Installment'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P29_MEMBER,P29_AMOUNT'
,p_triggering_condition_type=>'NOT_NULL'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31636450625788047)
,p_event_id=>wwv_flow_api.id(31636384485788046)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
'declare',
'',
'p_expected number := app.get_expected_installment(:p29_member);',
'',
'begin ',
'',
':p29_savings := to_char(:p29_amount - p_expected,''999,999,999.99'');',
':p29_weekly_repayment := to_char(p_expected,''999,999,999.99'');',
'',
'end;'))
,p_attribute_02=>'P29_MEMBER,P29_WEEKLY_REPAYMENT,P29_SAVINGS,P29_AMOUNT'
,p_attribute_03=>'P29_WEEKLY_REPAYMENT,P29_SAVINGS'
,p_attribute_04=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31633828246788021)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Process Collection'
,p_process_sql_clob=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'Declare',
'',
'v_savings number;',
'v_loan_installment number;',
'v_credit_officer_id number;',
'v_loan_id number;',
'',
'begin',
'  app.insert_collection(',
'      p_member_id => :p29_member,',
'      p_amount    => :p29_amount,',
'      p_group_id   =>     :p29_group,',
'      p_collection_date => :p29_collection_date,',
'      p_credit_officer_id => auth.user_id(:app_user));',
' /*',
' ',
' Select Weekly_Repayment, Id into v_loan_installment, v_loan_id from Loan where Member_Id = :P29_MEMBER and State =''disbursed'';',
' ',
' v_savings := :P29_AMOUNT - v_loan_installment;',
' v_credit_officer_id := auth.user_id(:app_user);',
' ',
' insert into Member_Collection (Savings, Loan_Installment, Group_Id, Collection_Date, Credit_Officer_Id, Amount, Loan_Id)',
' values (v_savings, v_loan_installment, :P29_GROUP, :P29_COLLECTION_DATE, v_credit_officer_id, :P29_AMOUNT, v_loan_id );',
' */',
':P29_GROUP := NULL;',
':P29_MEMBER := NULL;',
':P29_COLLECTION_DATE := NULL;',
':P29_AMOUNT := NULL;',
'',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(31633197040788014)
,p_process_success_message=>'1 Row Inserted. '
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(30585764931216438)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'Reset Page'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(30585475516216435)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31783962323160365)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(31784340170160365)
,p_name=>'Accounts'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#ed-item.gif"  border="0">'
,p_owner=>'ADMIN'
,p_internal_uid=>31784340170160365
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31784409812160369)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31784878670160372)
,p_db_column_name=>'NAME'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Name'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31785230235160372)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31785694692160372)
...
,p_column_type=>'NUMBER'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_rpt_named_lov=>wwv_flow_api.id(31802093841242362)
,p_rpt_show_filter_lov=>'1'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31786049888160373)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31786420248160373)
...
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'317901'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>50
,p_report_columns=>'ID:NAME:CODE:TYPE_ID:DATE_CREATED:USER_ID'
,p_flashback_enabled=>'N'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31787746659160375)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(31783962323160365)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--large'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31786885084160373)
,p_name=>'Edit Report - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(31783962323160365)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31787379482160374)
,p_event_id=>wwv_flow_api.id(31786885084160373)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(31783962323160365)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31788135689160375)
,p_name=>'Create Button - Dialog Closed'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(31787746659160375)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31788698313160375)
,p_event_id=>wwv_flow_api.id(31788135689160375)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31776591726160344)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30643849601989934)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31776926255160344)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(31776591726160344)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#:t-Button--large'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31776441188160344)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(31776591726160344)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31776334044160344)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(31776591726160344)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31776270434160344)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(31776591726160344)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(30584977005216430)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(31776591726160344)
...
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Save and Create New'
,p_button_position=>'REGION_TEMPLATE_NEXT'
,p_button_condition=>'P31_ID'
,p_button_condition_type=>'ITEM_IS_NULL'
,p_database_action=>'INSERT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(30584845182216429)
,p_branch_name=>'Reload Page'
,p_branch_action=>'f?p=&APP_ID.:31:&SESSION.::&DEBUG.:RP,31::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(30584977005216430)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31779308053160347)
,p_name=>'P31_ID'
,p_item_sequence=>10
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31779769062160353)
,p_name=>'P31_NAME'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(31775868659160343)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31780178175160354)
,p_name=>'P31_CODE'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(31775868659160343)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31780511027160354)
,p_name=>'P31_TYPE_ID'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(31775868659160343)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31780954688160355)
,p_name=>'P31_USER_ID'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(31775868659160343)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31777065494160344)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(31776926255160344)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31777865675160345)
,p_event_id=>wwv_flow_api.id(31777065494160344)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31782015376160356)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from ACCOUNT'
,p_attribute_02=>'ACCOUNT'
,p_attribute_03=>'P31_ID'
,p_attribute_04=>'ID'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31782449251160356)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of ACCOUNT'
,p_attribute_02=>'ACCOUNT'
,p_attribute_03=>'P31_ID'
,p_attribute_04=>'ID'
,p_attribute_11=>'I:U:D'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31782812425160357)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(31776441188160344)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31783299461160357)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(31776270434160344)
...
wwv_flow_api.create_page(
 p_id=>32
,p_user_interface_id=>wwv_flow_api.id(30678093337989972)
,p_name=>'Account Types'
,p_page_mode=>'NORMAL'
,p_step_title=>'Account Types'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_javascript_code=>'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
,p_page_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(31793733294216200)
,p_name=>'Account Types'
,p_template=>wwv_flow_api.id(31261378455831956)
,p_display_sequence=>15
,p_include_in_reg_disp_sel_yn=>'N'
...
'"ID" ID_DISPLAY,',
'"NAME"',
'from "#OWNER#"."ACCOUNT_TYPE"',
''))
,p_source_type=>'NATIVE_TABFORM'
,p_header=>'<h3>Account Types</h3>'
,p_ajax_enabled=>'N'
,p_query_row_template=>wwv_flow_api.id(30660670762989944)
,p_query_num_rows=>10
,p_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(31800099239216208)
,p_query_column_id=>1
,p_column_alias=>'CHECK$01'
,p_column_display_sequence=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(31794420455216202)
,p_query_column_id=>2
,p_column_alias=>'ID'
,p_column_display_sequence=>2
,p_column_heading=>'Id'
...
,p_ref_schema=>'REAGOVAT'
,p_ref_table_name=>'ACCOUNT_TYPE'
,p_ref_column_name=>'ID'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(31794806878216203)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(31795241241216203)
,p_query_column_id=>4
,p_column_alias=>'NAME'
,p_column_display_sequence=>4
,p_column_heading=>'Name'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31800975405216210)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31796845360216205)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(31793733294216200)
,p_button_name=>'ADD'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#:t-Button--large'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Add Account Type'
,p_button_position=>'BOTTOM'
,p_button_redirect_url=>'javascript:apex.widget.tabular.addRow();'
,p_button_execute_validations=>'N'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31796644854216205)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(31793733294216200)
,p_button_name=>'SUBMIT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31796599122216205)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(31793733294216200)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31796737352216205)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(31793733294216200)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(31800411005216208)
,p_branch_action=>'f?p=&APP_ID.:32:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(31796644854216205)
,p_branch_sequence=>1
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31798383372216206)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(31793733294216200)
,p_process_type=>'NATIVE_TABFORM_UPDATE'
,p_process_name=>'ApplyMRU'
,p_attribute_02=>'ACCOUNT_TYPE'
,p_attribute_03=>'ID'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(31796644854216205)
,p_process_success_message=>'#MRU_COUNT# row(s) updated, #MRI_COUNT# row(s) inserted.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31798711993216207)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(31793733294216200)
...
wwv_flow_api.create_page(
 p_id=>33
,p_user_interface_id=>wwv_flow_api.id(30678093337989972)
,p_name=>'Journal Types'
,p_page_mode=>'NORMAL'
,p_step_title=>'Journal Types'
,p_step_sub_title=>'Journal Types'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_javascript_code=>'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
,p_page_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(31805605221313442)
,p_name=>'Journal Types'
,p_template=>wwv_flow_api.id(31261378455831956)
,p_display_sequence=>15
,p_include_in_reg_disp_sel_yn=>'N'
...
'"ID" ID_DISPLAY,',
'"NAME"',
'from "#OWNER#"."JOURNAL_TYPE"',
''))
,p_source_type=>'NATIVE_TABFORM'
,p_header=>'<h3>Journal Types</h3>'
,p_ajax_enabled=>'N'
,p_query_row_template=>wwv_flow_api.id(30660670762989944)
,p_query_num_rows=>10
,p_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(31806037912313444)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>2
,p_disable_sort_column=>'N'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(31806458212313444)
,p_query_column_id=>2
,p_column_alias=>'ID_DISPLAY'
,p_column_display_sequence=>3
,p_hidden_column=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(31806813785313444)
,p_query_column_id=>3
,p_column_alias=>'NAME'
,p_column_display_sequence=>4
,p_column_heading=>'Name'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(31807248922313444)
,p_query_column_id=>4
,p_column_alias=>'CHECK$01'
,p_column_display_sequence=>1
,p_column_heading=>'Select Row'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31810011673313448)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31808837554313446)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(31805605221313442)
,p_button_name=>'ADD'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#:t-Button--large'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Add Journal Type'
,p_button_position=>'BOTTOM'
,p_button_redirect_url=>'javascript:apex.widget.tabular.addRow();'
,p_button_execute_validations=>'N'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31807634526313445)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(31805605221313442)
,p_button_name=>'SUBMIT'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31808005865313445)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(31805605221313442)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31808467512313445)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(31805605221313442)
,p_button_name=>'MULTI_ROW_DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(31810878801313450)
,p_branch_action=>'f?p=&APP_ID.:33:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(31807634526313445)
,p_branch_sequence=>1
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31809234188313447)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(31805605221313442)
,p_process_type=>'NATIVE_TABFORM_UPDATE'
,p_process_name=>'ApplyMRU'
,p_attribute_02=>'JOURNAL_TYPE'
,p_attribute_03=>'ID'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(31807634526313445)
,p_process_success_message=>'#MRU_COUNT# row(s) updated, #MRI_COUNT# row(s) inserted.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31809608066313447)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_region_id=>wwv_flow_api.id(31805605221313442)
,p_process_type=>'NATIVE_TABFORM_DELETE'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20160622142311'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31823991773398176)
,p_plug_name=>'Journal'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader:t-Region--scrollBody:t-Form--labelsAbove'
,p_plug_template=>wwv_flow_api.id(31261378455831956)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(31824362167398176)
,p_name=>'Journal'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#ed-item.gif"  border="0">'
,p_owner=>'ADMIN'
,p_internal_uid=>31824362167398176
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31824410729398176)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31824813035398177)
,p_db_column_name=>'NAME'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Name'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31825238359398177)
,p_db_column_name=>'TYPE_ID'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Account Type'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31825619364398178)
,p_db_column_name=>'DEBIT_ID'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Debit Account'
,p_column_type=>'NUMBER'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_rpt_named_lov=>wwv_flow_api.id(31842162657827625)
,p_rpt_show_filter_lov=>'1'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31826000787398178)
,p_db_column_name=>'CREDIT_ID'
,p_display_order=>5
,p_column_identifier=>'E'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31826485629398178)
,p_db_column_name=>'USER_ID'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'User Id'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(30585015789216431)
,p_db_column_name=>'SHORTCODE'
,p_display_order=>16
,p_column_identifier=>'G'
,p_column_label=>'Code'
,p_column_type=>'STRING'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(31830447561399534)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'318305'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>50
,p_report_columns=>'ID:NAME:TYPE_ID:DEBIT_ID:CREDIT_ID:USER_ID:SHORTCODE'
,p_flashback_enabled=>'N'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31829289945398180)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31827725938398179)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(31823991773398176)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--large'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31826846398398178)
,p_name=>'Edit Report - Dialog Closed'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(31823991773398176)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31827357153398179)
,p_event_id=>wwv_flow_api.id(31826846398398178)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(31823991773398176)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31828163689398179)
,p_name=>'Create Button - Dialog Closed'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(31827725938398179)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31828696049398179)
,p_event_id=>wwv_flow_api.id(31828163689398179)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_api.create_page(
 p_id=>35
,p_user_interface_id=>wwv_flow_api.id(30678093337989972)
,p_name=>'Manage Journal'
,p_page_mode=>'MODAL'
,p_step_title=>'Manage Journal'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_javascript_code=>'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
,p_page_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31814335336398169)
,p_plug_name=>'Manage Journal'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30643706521989934)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31815040379398169)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30643849601989934)
,p_plug_display_sequence=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31815445600398169)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(31815040379398169)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#:t-Button--large'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31814997426398169)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(31815040379398169)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31814815474398169)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(31815040379398169)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31814773227398169)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(31815040379398169)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(30585254013216433)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(31815040379398169)
,p_button_name=>'CREATE_ANOTHER'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(30585378676216434)
,p_branch_name=>'Reload Page'
,p_branch_action=>'f?p=&APP_ID.:35:&SESSION.::&DEBUG.:RP,35::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(30585254013216433)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30585196700216432)
,p_name=>'P35_CODE'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(31814335336398169)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Code'
,p_placeholder=>'SAVJ'
,p_source=>'SHORTCODE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31817857584398171)
,p_name=>'P35_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(31814335336398169)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31818218508398171)
,p_name=>'P35_NAME'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(31814335336398169)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31818676985398171)
,p_name=>'P35_TYPE_ID'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(31814335336398169)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31819063400398172)
,p_name=>'P35_DEBIT_ID'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(31814335336398169)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31819418783398172)
,p_name=>'P35_CREDIT_ID'
,p_is_required=>true
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(31814335336398169)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31819881141398172)
,p_name=>'P35_DATE_CREATED'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(31814335336398169)
,p_use_cache_before_default=>'NO'
,p_item_default=>'sysdate'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31820284303398172)
,p_name=>'P35_USER_ID'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(31814335336398169)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(31815566609398169)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(31815445600398169)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(31816306506398170)
,p_event_id=>wwv_flow_api.id(31815566609398169)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31821089270398173)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from JOURNAL'
,p_attribute_02=>'JOURNAL'
,p_attribute_03=>'P35_ID'
,p_attribute_04=>'ID'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31821473804398173)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of JOURNAL'
,p_attribute_02=>'JOURNAL'
,p_attribute_03=>'P35_ID'
,p_attribute_04=>'ID'
,p_attribute_11=>'I:U:D'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31821860368398173)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(31814997426398169)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31822295744398173)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
...
wwv_flow_api.create_page(
 p_id=>36
,p_user_interface_id=>wwv_flow_api.id(30678093337989972)
,p_name=>'Member Portfilio'
,p_page_mode=>'NORMAL'
,p_step_title=>'Member Portfilio'
,p_step_sub_title=>'Member Portfilio'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_page_template_options=>'#DEFAULT#'
,p_dialog_chained=>'Y'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20160624162847'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(32575279633115996)
,p_plug_name=>'Members'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader:t-Region--scrollBody:t-Form--labelsAbove'
,p_plug_template=>wwv_flow_api.id(31261378455831956)
,p_plug_display_sequence=>10
...
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select m.id, ',
'INITCAP(m.firstname)||'' ''||INITCAP(m.lastname) fullname,',
'm.credit_officer_id,',
'"EMAIL",',
'app.saving_balance(m.id) Savings_balance,',
'accounting.cash_security(m.id) cash_security,',
'app.current_loan(m.id) current_loan,',
'app.total_installment_by_member(m.id) total_installment,',
'app.outstanding_loan(m.id) outstanding_installment,',
'app. loan_interest_receivable(m.id) interest_receivable,',
'm.group_id, g.name group_name,',
'registration_amount ',
'from members m,groups g where m.group_id=:p36_group and m.group_id=g.id',
'and m.credit_officer_id=auth.user_id(:p36_credit_officer) order by m.id desc',
'  ',
''))
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_row_template=>1
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(32575608477115996)
,p_name=>'Members'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_download_formats=>'CSV:HTML:EMAIL:XLS:PDF:RTF'
,p_owner=>'ADMIN'
,p_internal_uid=>32575608477115996
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32575728849115997)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32579384531115999)
,p_db_column_name=>'FULLNAME'
,p_display_order=>11
,p_column_identifier=>'V'
,p_column_label=>'Member '
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32576515486115997)
,p_db_column_name=>'EMAIL'
,p_display_order=>31
,p_column_identifier=>'G'
,p_column_label=>'Email'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32576974173115997)
,p_db_column_name=>'GROUP_ID'
,p_display_order=>41
,p_column_identifier=>'K'
,p_column_label=>'Group'
,p_column_link=>'f?p=&APP_ID.:9:&SESSION.::&DEBUG.:RP:P9_ID:#GROUP_ID#'
,p_column_linktext=>'#GROUP_NAME#'
,p_column_link_attr=>'style="text-decoration:underline"'
,p_column_type=>'NUMBER'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32577303241115998)
,p_db_column_name=>'REGISTRATION_AMOUNT'
,p_display_order=>51
,p_column_identifier=>'M'
,p_column_label=>'Registered With'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32577799288115998)
,p_db_column_name=>'SAVINGS_BALANCE'
,p_display_order=>61
,p_column_identifier=>'R'
,p_column_label=>'Savings Bal.'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32578189866115998)
,p_db_column_name=>'CURRENT_LOAN'
,p_display_order=>71
,p_column_identifier=>'S'
,p_column_label=>'Current Loan'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32578503020115998)
,p_db_column_name=>'TOTAL_INSTALLMENT'
,p_display_order=>81
,p_column_identifier=>'T'
,p_column_label=>'Total Installment'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32578919980115999)
,p_db_column_name=>'OUTSTANDING_INSTALLMENT'
,p_display_order=>91
,p_column_identifier=>'U'
,p_column_label=>'Outstanding Installment'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32579723492115999)
,p_db_column_name=>'CASH_SECURITY'
,p_display_order=>101
,p_column_identifier=>'W'
,p_column_label=>'Cash Security'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32580141106115999)
,p_db_column_name=>'INTEREST_RECEIVABLE'
,p_display_order=>111
,p_column_identifier=>'X'
,p_column_label=>'Interest Receivable'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32496063257014526)
,p_db_column_name=>'CREDIT_OFFICER_ID'
,p_display_order=>121
...
,p_column_type=>'NUMBER'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_rpt_named_lov=>wwv_flow_api.id(30934190727227543)
,p_rpt_show_filter_lov=>'1'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32496464429014530)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(32580591854116000)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'325806'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>50
,p_report_columns=>'ID:EMAIL:GROUP_ID:REGISTRATION_AMOUNT:SAVINGS_BALANCE:CURRENT_LOAN:TOTAL_INSTALLMENT:OUTSTANDING_INSTALLMENT:FULLNAME:CASH_SECURITY:INTEREST_RECEIVABLE:CREDIT_OFFICER_ID:GROUP_NAME'
,p_flashback_enabled=>'N'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(32582247449116004)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(32581096225116000)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(32575279633115996)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--large'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32495807458014524)
,p_name=>'P36_CREDIT_OFFICER'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(32575279633115996)
,p_prompt=>'Credit Officer'
,p_source=>'P36_CREDIT_OFFICER'
,p_source_type=>'ITEM'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_named_lov=>'CREDIT_OFFICER_BY_EMAIL'
,p_lov=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select name || '' - ''|| email as d,',
'       email as r',
'  from users where role_id=3',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32581487736116001)
,p_name=>'P36_DAY_OF_WEEK'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(32575279633115996)
,p_item_default=>'app.active_day'
,p_item_default_type=>'PLSQL_EXPRESSION'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32581872030116003)
,p_name=>'P36_GROUP'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(32575279633115996)
,p_use_cache_before_default=>'NO'
...
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'-- select email into :p36_user from users where id = :p36_credit_officer;',
'return app.get_groups',
'    (',
'      p_username => :p36_credit_officer,',
'      p_dow   =>   :p36_day_of_week,',
'      p_except =>0',
'    );',
'    '))
,p_lov_cascade_parent_items=>'P36_DAY_OF_WEEK,P36_CREDIT_OFFICER'
,p_ajax_optimize_refresh=>'Y'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_field_template=>wwv_flow_api.id(30672380578989951)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(32496149658014527)
,p_name=>'Reload report'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P36_CREDIT_OFFICER,P36_DAY_OF_WEEK,P36_GROUP'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(32496218769014528)
,p_event_id=>wwv_flow_api.id(32496149658014527)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(32575279633115996)
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>37
,p_user_interface_id=>wwv_flow_api.id(30678093337989972)
,p_name=>'Journal Entries'
,p_page_mode=>'NORMAL'
,p_step_title=>'Journal Entries'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_page_template_options=>'#DEFAULT#'
,p_dialog_chained=>'Y'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20160622175809'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31964715247626806)
,p_plug_name=>'Journal Entries'
,p_region_template_options=>'#DEFAULT#'
...
'related_document,',
'document_id ',
'from "#OWNER#"."JOURNAL_ITEMS" order by date_created desc',
'  ',
''))
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_row_template=>1
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(31965167881626806)
,p_name=>'Journal Entries'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#ed-item.gif"  border="0">'
,p_owner=>'ADMIN'
,p_internal_uid=>31965167881626806
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31965220205626807)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31974233455638019)
,p_db_column_name=>'NAME'
,p_display_order=>11
,p_column_identifier=>'K'
,p_column_label=>'Journal Entry'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31965606321626808)
,p_db_column_name=>'JOURNAL_ID'
,p_display_order=>21
,p_column_identifier=>'B'
,p_column_label=>'Journal'
,p_column_type=>'NUMBER'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_rpt_named_lov=>wwv_flow_api.id(31986186718890787)
,p_rpt_show_filter_lov=>'1'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31966098781626808)
,p_db_column_name=>'MEMBER_ID'
,p_display_order=>31
,p_column_identifier=>'C'
,p_column_label=>'Member'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31966446992626808)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31973054663638007)
,p_db_column_name=>'AMOUNT'
,p_display_order=>51
,p_column_identifier=>'F'
,p_column_label=>'Amount'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31973210388638009)
...
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_column_alignment=>'RIGHT'
,p_rpt_named_lov=>wwv_flow_api.id(31813314490351964)
,p_rpt_show_filter_lov=>'1'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31973306211638010)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31973492861638011)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31973136138638008)
,p_db_column_name=>'USER_ID'
,p_display_order=>91
,p_column_identifier=>'G'
,p_column_label=>'User'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(31972935155638006)
,p_db_column_name=>'DATE_CREATED'
,p_display_order=>101
,p_column_identifier=>'E'
,p_column_label=>'Date created'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(31968665223628188)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'319687'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>50
,p_report_columns=>'ID:JOURNAL_ID:MEMBER_ID:ACCOUNT_ID:DATE_CREATED:AMOUNT:USER_ID:TRANSACTION_TYPE:RELATED_DOCUMENT:DOCUMENT_ID:NAME'
,p_flashback_enabled=>'N'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31967435624626809)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31966811866626809)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(31964715247626806)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Create Journal Item'
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
...
wwv_flow_api.create_page(
 p_id=>38
,p_user_interface_id=>wwv_flow_api.id(30678093337989972)
,p_name=>'Manage Journal Item'
,p_page_mode=>'MODAL'
,p_step_title=>'Manage Journal Item'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_javascript_code=>'var htmldb_delete_message=''"DELETE_CONFIRM_MSG"'';'
,p_step_template=>wwv_flow_api.id(30641885972989930)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(31957998845626787)
,p_plug_name=>'Manage Journal Item'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader:t-Region--noBorder:t-Region--scrollBody:t-Form--labelsAbove'
,p_plug_template=>wwv_flow_api.id(31261378455831956)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31958459408626788)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(31957998845626787)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31958615465626788)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(31957998845626787)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31958315063626788)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(31957998845626787)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(31958535658626788)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(31957998845626787)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(31960218557626789)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31960635532626790)
,p_name=>'P38_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(31957998845626787)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31961035691626796)
,p_name=>'P38_JOURNAL_ID'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(31957998845626787)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Journal'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31961429788626797)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31961885875626797)
,p_name=>'P38_ACCOUNT_ID'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(31957998845626787)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Account'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31972521262638002)
,p_name=>'P38_AMOUNT'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(31957998845626787)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31972653914638003)
,p_name=>'P38_TRANSACTION_ID'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(31957998845626787)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31972746087638004)
,p_name=>'P38_NAME'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(31957998845626787)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(31972847661638005)
,p_name=>'P38_USER_ID'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(31957998845626787)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31962685569626798)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from JOURNAL_ITEMS'
,p_attribute_02=>'JOURNAL_ITEMS'
,p_attribute_03=>'P38_ID'
,p_attribute_04=>'ID'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31963078376626798)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of JOURNAL_ITEMS'
,p_attribute_02=>'JOURNAL_ITEMS'
,p_attribute_03=>'P38_ID'
,p_attribute_04=>'ID'
,p_attribute_11=>'I:U:D'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31963441126626799)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(31958535658626788)
);
end;
/
...
wwv_flow_api.create_page(
 p_id=>39
,p_user_interface_id=>wwv_flow_api.id(30678093337989972)
,p_name=>'System Config'
,p_page_mode=>'NORMAL'
,p_step_title=>'System Config'
,p_step_sub_title_type=>'TEXT_WITH_SUBSTITUTIONS'
,p_first_item=>'NO_FIRST_ITEM'
,p_page_template_options=>'#DEFAULT#'
,p_dialog_chained=>'Y'
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20160622170344'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(32081048529713536)
,p_plug_name=>'Systems Operations'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader:t-Region--scrollBody:t-Form--labelsAbove'
,p_plug_template=>wwv_flow_api.id(31261378455831956)
,p_plug_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(32141887678634264)
,p_plug_name=>'System Config'
,p_region_template_options=>'#DEFAULT#:t-Region--hideHeader:t-Region--scrollBody:t-Form--labelsAbove'
,p_plug_template=>wwv_flow_api.id(31261378455831956)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(32147956601634275)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30655173462989940)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(32081117225713537)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(32081048529713536)
,p_button_name=>'CLEAR_DATABASE'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#:t-Button--large:t-Button--noUI'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Reset Database'
,p_button_position=>'BELOW_BOX'
,p_button_alignment=>'LEFT'
,p_button_redirect_url=>'javascript:apex.confirm(''This operation delete all member data from system'',''CLEAR_DATABASE'');'
,p_button_execute_validations=>'N'
,p_button_condition=>'return app.system_mode = ''DEVELOPMENT'';'
,p_button_condition_type=>'FUNCTION_BODY'
,p_button_css_classes=>'link'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(32142286705634264)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(32141887678634264)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(30672878552989954)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(32142384582634265)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(32141887678634264)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(32143187334634265)
...
,p_branch_condition=>'SAVE,CANCEL'
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(32081218669713538)
,p_branch_name=>'Reload Page'
,p_branch_action=>'f?p=&APP_ID.:39:&SESSION.::&DEBUG.:RP:P39_ID:&P39_ID.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>11
,p_branch_condition_type=>'REQUEST_IN_CONDITION'
,p_branch_condition=>'RESET_DATABASE'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32077794787713503)
,p_name=>'P39_MAX_MEMBERS'
,p_is_required=>true
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(32141887678634264)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Group Max. Members'
,p_source=>'MAX_MEMBERS'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>32
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32077846350713504)
,p_name=>'P39_MAX_GROUPS'
,p_is_required=>true
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(32141887678634264)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Max. Members/Group'
,p_source=>'MAX_GROUPS'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>32
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32077970573713505)
,p_name=>'P39_PCT_EQUITY'
,p_is_required=>true
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(32141887678634264)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Loan Equity (%)'
,p_source=>'LOAN_EQUITY'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>32
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32078096089713506)
,p_name=>'P39_INTEREST_RATE'
,p_is_required=>true
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(32141887678634264)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32080924919713535)
,p_name=>'P39_SYSTEM_MODE'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(32141887678634264)
,p_use_cache_before_default=>'NO'
,p_prompt=>'System Mode'
,p_source=>'SYSTEM_MODE'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'STATIC:DEVELOPMENT;DEVELOPMENT,PRODUCTION;PRODUCTION'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_colspan=>4
,p_field_template=>wwv_flow_api.id(30672692966989952)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32081416067713540)
,p_name=>'P39_LOAN_MIN_SAVING'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(32141887678634264)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Loan Min. Saving'
,p_source=>'LOAN_MIN_SAVING'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>32
,p_begin_on_new_line=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32143566204634266)
,p_name=>'P39_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(32141887678634264)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32143925214634271)
,p_name=>'P39_REGISTRATION_FEE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(32141887678634264)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Registration Fee'
,p_source=>'REGISTRATION_FEE'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>32
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32144325942634272)
,p_name=>'P39_PASSBOOK_FEE'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(32141887678634264)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Passbook Fee'
,p_source=>'PASSBOOK_FEE'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>32
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32144790345634272)
,p_name=>'P39_PASSPORT_FEE'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(32141887678634264)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Passport Fee'
,p_source=>'PASSPORT_FEE'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>32
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32145193857634273)
,p_name=>'P39_IDCARD_FEE'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(32141887678634264)
,p_use_cache_before_default=>'NO'
,p_prompt=>'ID Card Fee'
,p_source=>'IDCARD_FEE'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>32
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32145533232634273)
,p_name=>'P39_SMALL_SAVING_DEPOSIT'
,p_is_required=>true
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(32141887678634264)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Small Saving Deposit'
,p_source=>'SMALL_SAVING_DEPOSIT'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>32
,p_cMaxlength=>255
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32145942532634273)
,p_name=>'P39_PCT_LOAN_PROCESSING_FEE'
,p_is_required=>true
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(32141887678634264)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Loan Processing Fee (%)'
,p_source=>'PCT_LOAN_PROCESSING_FEE'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_NUMBER_FIELD'
,p_cSize=>32
,p_cMaxlength=>255
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(32147164853634274)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of SYSTEM_CONFIG'
,p_attribute_02=>'SYSTEM_CONFIG'
,p_attribute_03=>'P39_ID'
,p_attribute_04=>'ID'
,p_attribute_11=>'U'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(32142286705634264)
,p_process_success_message=>'Action Processed.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(32081312250713539)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Reset Database'
,p_process_sql_clob=>'begin app.reset_database; end;'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(32081117225713537)
,p_process_success_message=>'Database reset successful'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(32147523000634274)
,p_process_sequence=>50
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(32146729094634274)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from SYSTEM_CONFIG'
,p_attribute_02=>'SYSTEM_CONFIG'
,p_attribute_03=>'P39_ID'
,p_attribute_04=>'ID'
);
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20160624190036'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(32604918134690211)
...
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_utilities.join(wwv_flow_t_varchar2(
'select account_id,sum(amount) credit,null debit',
'from journal_items where transaction_type=1  and date_created between :p40_start and :p40_end',
'group by rollup (account_id)',
'union all ',
'select account_id ,null credit,sum(amount) debit',
'from journal_items where transaction_type=2 and date_created between :p40_start and :p40_end',
'group by rollup (account_id)'))
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(32605083737690211)
,p_name=>'Trial Balance'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_download_formats=>'CSV:HTML:EMAIL:XLS:PDF:RTF'
,p_owner=>'ADMIN'
,p_internal_uid=>32605083737690211
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32496854379014534)
,p_db_column_name=>'ACCOUNT_ID'
,p_display_order=>10
,p_column_identifier=>'G'
,p_column_label=>'Account'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32496677212014532)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(32496772141014533)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(32606888172698682)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'326069'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>50
,p_report_columns=>'IDING.TOTAL_CREDIT(A.ID)ING.TOTAL_DEBIT(A.ID):CREDIT:DEBIT:ACCOUNT_ID'
,p_flashback_enabled=>'N'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(32497230826014538)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(32604918134690211)
,p_button_name=>'SUBMIT'
,p_button_action=>'SUBMIT'
...
,p_button_image_alt=>'Submit'
,p_button_position=>'BODY'
,p_button_cattributes=>'style="padding: 0 0 10px 0"'
,p_grid_column_attributes=>'style="padding: 10px 0 10px 0"'
,p_grid_new_row=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32496979368014535)
,p_name=>'P40_START'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(32604918134690211)
,p_item_default=>'to_char(''01-JAN-''||to_char(sysdate,''YYYY''))'
,p_item_default_type=>'PLSQL_EXPRESSION'
,p_prompt=>'Start'
,p_source=>'P40_START'
,p_source_type=>'ITEM'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(32497041744014536)
,p_name=>'P40_END'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(32604918134690211)
,p_item_default=>'sysdate'
...
,p_button_name=>'LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'t-Button--large:t-Button--iconLeft:t-Button--gapRight'
,p_button_template_id=>wwv_flow_api.id(30672914412989954)
,p_button_is_hot=>'Y'
